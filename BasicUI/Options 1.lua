...
local function GetOptions()
	db = BasicUI.db.profile
	
	local regions ={['TOPLEFT'] = L['TOPLEFT'], ['TOP'] = L['TOP'], ['TOPRIGHT'] = L['TOPRIGHT'], ['LEFT'] = L['LEFT'], ['CENTER'] = L['CENTER'], ['RIGHT'] = L['RIGHT'], ['BOTTOMLEFT'] = L['BOTTOMLEFT'], ['BOTTOM'] = L['BOTTOM'], ['BOTTOMRIGHT'] = L['BOTTOMRIGHT']}
		...
		options = {
			...
			args = {
				...
				general = {
					...
					desc = L["General Options for |cff00B4FFBasic|rUI."],
					--childGroups = "tree",
				...
				actionbar = {					
					...
					args = {
						...
						color = {
							...
							set = function(info, value) db.actionbar.color[ info[#info] ] = value; StaticPopup_Show("CFG_RELOAD") end,
							args = {
								---------------------------
								--Option Type Seperators
								sep1 = {
				...
				datapanel = {
					type = "group",			
					order = 5,
					name = L["|cff00B4FFDatapanel|r"],
					desc = L["datapanel Module for |cff00B4FFBasic|rUI."],
					childGroups = "tree",
					get = function(info) return db.datapanel[ info[#info] ] end,
					set = function(info, value) db.datapanel[ info[#info] ] = value; StaticPopup_Show("CFG_RELOAD") end,				
					args = {
						---------------------------
						--Option Type Seperators
						sep1 = {
				...
				merchant = {
					...
					args = {
						...
						disenchant = {
							...
							order = 1,								
							name = L["DisEnchant"],
							desc = L["Check this box if you want to Disenchant all green items. Leave unchecked if you just want to roll greed."],
							disabled = function() return not db.merchant.enable end,																
						},
					},
				},
...
function BasicUI:SetUpOptions()
	...
	LibStub("AceConfig-3.0"):RegisterOptionsTable("BasicUI", GetOptions);
	LibStub("AceConfig-3.0"):RegisterOptionsTable("BasicUI-Profiles", LibStub("AceDBOptions-3.0"):GetOptionsTable(self.db));
	
	self.optionsFrame = LibStub("AceConfigDialog-3.0"):AddToBlizOptions("BasicUI", "|cff00B4FFBasic|rUI");
	self.profilesFrame = LibStub("AceConfigDialog-3.0"):AddToBlizOptions("BasicUI-Profiles", "Profiles", "|cff00B4FFBasic|rUI");
