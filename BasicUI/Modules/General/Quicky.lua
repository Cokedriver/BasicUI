...
f.Head:SetNormalTexture('Interface\\AddOns\\BasicUI\\Media\\Textures\\textureNormal')
f.Head:SetHighlightTexture('Interface\\AddOns\\BasicUI\\Media\\Textures\\textureHighlight')
f.Head:SetPushedTexture('Interface\\AddOns\\BasicUI\\Media\\Textures\\texturePushed')
...
f.Cloak:SetNormalTexture('Interface\\AddOns\\BasicUI\\Media\\Textures\\textureNormal')
f.Cloak:SetHighlightTexture('Interface\\AddOns\\BasicUI\\Media\\Textures\\textureHighlight')
f.Cloak:SetPushedTexture('Interface\\AddOns\\BasicUI\\Media\\Textures\\texturePushed')
