...
function BasicUI_Fonts:OnEnable()
	...
	-- Base fonts
	SetFont(AchievementFont_Small,                BOLD, db.general.fontSize)
	...
	SetFont(FriendsFont_Small,                  NORMAL, db.general.fontSize, nil, nil, nil, nil, 0, 0, 0, 1, -1)
	...
	SetFont(InvoiceFont_Small,                  ITALIC, db.general.fontSize, nil, 0.15, 0.09, 0.04)
	...
	SetFont(NumberFont_Shadow_Small,            NORMAL, db.general.fontSize)
	...
	SetFont(SpellFont_Small,                      BOLD, db.general.fontSize)
	SetFont(SystemFont_InverseShadow_Small,       BOLD, db.general.fontSize)
	SetFont(SystemFont_Large,                   NORMAL, 17)
	SetFont(SystemFont_Med1,                    NORMAL, db.general.fontSize)
	...
	SetFont(SystemFont_Outline_Small,           NUMBER, db.general.fontSize, "OUTLINE")
	SetFont(SystemFont_Shadow_Huge1,              BOLD, 20)
	SetFont(SystemFont_Shadow_Huge3,              BOLD, 25)
	SetFont(SystemFont_Shadow_Large,            NORMAL, 17)
	SetFont(SystemFont_Shadow_Med1,             NORMAL, db.general.fontSize)
	SetFont(SystemFont_Shadow_Med2,             NORMAL, db.general.fontSize)
	SetFont(SystemFont_Shadow_Med3,             NORMAL, db.general.fontSize)
	SetFont(SystemFont_Shadow_Outline_Huge2,    NORMAL, 22, "OUTLINE")
	SetFont(SystemFont_Shadow_Small,              BOLD, db.general.fontSize)
	SetFont(SystemFont_Small,                   NORMAL, db.general.fontSize)
	SetFont(SystemFont_Tiny,                    NORMAL, db.general.fontSize)
