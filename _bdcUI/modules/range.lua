...
if cfg.range.enable ~= true then return end

--[[

	All Create for range.lua goes to Tuller.
	tullaRange = http://www.wowinterface.com/downloads/info15636-tullaRange.html.
