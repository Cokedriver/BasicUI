...
L["Datapanel"] = true
L["If checked then panel moves to top of screen, If unchecked panel moves below MainMenuBar"] = true
L["Threatbar"] = true
...
L["Datatext Text Colors."] = true
L["Class Color"] = true
L["Color the datatext values based on your class"] = true
L["Text Colors"] = true
L["Custom Color"] = true
L["Picks a Custom Color for the datatext values."] = true
L["Stat #1"] = true
...
L["Open All"] = true
L["Enables Open All Collect Button on Mailbox"] = true
L["Range"] = true
