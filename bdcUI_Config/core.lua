					...
					value = {
						...
						args = {
							...
							Abbrev = {
								order = 1,
								name = L["valueAbbrev"],
								desc = L["Abbreviates the value."],
								type = "toggle",
								disabled = function() return not db.powerbar.enable end,
							},
							FontOutline = {
								order = 2,
								name = L["valueFontOutline"],
