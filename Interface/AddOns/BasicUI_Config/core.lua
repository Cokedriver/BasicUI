					...
					DataGroup = {
						...
						args = {
							...
							micromenu = {
								...
								type = "range",
								name = L["Micromenu"],
								desc = L["Display the Micromenu"]..L["\n\n0 - Disabled\n1 - POSITION #1\n2 - POSITION #2\n3 - POSITION #3\n4 - POSITION #4\n5 - POSITION #5\n6 - POSITION #6\n7 - POSITION #7\n8 - POSITION #8\n9 - POSITION #9"],
								min = 0, max = 9, step = 1,								
							},
							pro = {
								order = 11,
			...
			nameplates = {
				...
				args = {
					intro = {
						order = 1,
						type = "description",
						name = L["Adjust Custom Nameplates."],
					},			
					enable = {
						order = 2,
						name = L["Enable"],
						desc = L["Enables Nameplates Module"],
						type = "toggle",							
					},					
					colorswitcher = {
						order = 3,
						name = L["Color Swap"],
						desc = L["Swap background and foreground color."],
						type = "toggle",
					...
					showhpvalue = {
						order = 4,
						name = L["HP Value"],
						desc = L["Enable HP value on the nameplates."],
						type = "toggle",
						disabled = function() return not db.nameplates.enable end,
					},
					alwaysshowhp = {
						order = 5,
						name = L["Always Show Value"],
						desc = L["Will make the HP value appear even if the unit has 100% life, requires showhpvalue to be true."],
						type = "toggle",
						disabled = function() return not db.nameplates.enable end,
					},					
				},
...
function BasicUIConfig:SetDefaultOptions()
	...
	addon.datatext = {	
		...
		['color'] = "00AAFF",                  				-- datatext color if classcolor = false 
